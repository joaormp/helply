        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="sm:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold text-lg sm:text-xl px-4 py-2 rounded-lg">
                Helply
              </div>
            </div>
          ...
          {/* Product Links */}
          <div>
            <h3 className="font-bold text-base sm:text-lg mb-3 sm:mb-4">{t.footer.product}</h3>
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <a href="#pricing" className="text-sm sm:text-base text-gray-400 hover:text-white transition-colors">
                  {t.footer.pricing}
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-gray-400 text-xs sm:text-sm text-center sm:text-left">
              © {currentYear} Helply. {t.footer.rights}
            </p>
