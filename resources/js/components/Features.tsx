  ...
  const features = [
    {
      ...
      description: t.features.ticketManagement.description,
    ...
    },
    {
      ...
      title: t.features.emailIntegration.title,
      description: t.features.emailIntegration.description,
    ...
    },
    {
      ...
      title: t.features.cannedReplies.title,
      description: t.features.cannedReplies.description,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            ...
            >
              {/* Icon */}
              <div className={`inline-flex p-3 sm:p-4 rounded-xl bg-gradient-to-r ${feature.color} text-white mb-4 sm:mb-6 transform group-hover:scale-110 transition-transform duration-300`}>
                {feature.icon}
              </div>
